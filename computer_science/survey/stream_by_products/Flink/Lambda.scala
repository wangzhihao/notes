...
val absoluteStream = senv.fromElements(("jim", 12, Timestamp.valueOf("2019-02-20 00:00:00").getTime()), ("Amy", 10, Timestamp.valueOf("2019-02-28 00:00:00").getTime()), ("jim", 20, Timestamp.valueOf("2019-03-02 00:00:00").getTime()))
val deltaStream = senv.fromElements(("jim", 1, Timestamp.valueOf("2019-02-20 00:00:59").getTime()), ("Amy", 3, Timestamp.valueOf("2019-02-28 12:00:00").getTime()), ("jim", 8, Timestamp.valueOf("2019-03-02 00:23:00").getTime()))
