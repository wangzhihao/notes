...
Thanks to xinyu, he told me the two answers are actually Chebyshev distance and Manhattan distance, which is quite interesting especially when I notice Chebyshev distance is $L_{\infty}$ distance and Manhattan distance is $L_{1}$ distance in $L_p$ metrics.
